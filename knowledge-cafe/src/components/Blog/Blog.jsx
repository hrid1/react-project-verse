    ...
    <>
      <div className="my-2 mx-8 mb-10">
        ...
        <div className="flex items-center justify-between p-2 w-11/12">
          ...
          <div className="flex gap-2 items-center">
          <p>{minute} minute</p>
          <span onClick={() => {addBookmark(props.blog)}} className="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
