...
const SingleData = (props) => {
  const {id, name, features, description, published_in, image } = props.data;
    ...
    <>
      <div className=" w-full shadow-orange-50 shadow-lg p-2 rounded m-5">
        ...
        <div className="flex items-center justify-between ">
          ...
          <label htmlFor="my_modal_6" className="cursor-pointer p-1 border border-gray-800 rounded-lg " onClick={ () => {document.getElementById('my_modal_4').showModal(); props.setUniqueId(id) }}>
